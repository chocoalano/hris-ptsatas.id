@extends('layouts.app')
@section('title', 'home')
@section('keyword', 'Silicon - Multipurpose Technology')
@section('description', 'Bootstrap Templatebootstrap, business, creative agency, mobile app showcase, saas, fintech, finance, online courses, software, medical, conference landing, services, e-commerce, shopping cart, multipurpose, shop, ui kit, marketing, seo, landing, blog, portfolio, html5, css3, javascript, gallery, slider, touch, creative')
@section('title', '')
@section('css', '')
@section('js', '')
@section('content')
        ...
        <div class="container position-relative zindex-5 pb-md-4 pt-md-2 pt-lg-3 pb-lg-5">
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-0 pb-xl-3">
                ...
                <div class="col position-relative">
                    <div class="card border-0 bg-transparent rounded-0 p-md-1 p-xl-3">
                        <div class="d-table bg-secondary rounded-3 p-3 mx-auto mt-3 mt-md-4">
                            <img src="{{ asset('compro/assets/img/landing/saas-2/features/comments.svg') }}" width="40"
                                alt="Comments">
                        </div>
                ...
                <div class="col position-relative">
                    <div class="card border-0 bg-transparent rounded-0 p-md-1 p-xl-3">
                        <div class="d-table bg-secondary rounded-3 p-3 mx-auto mt-3 mt-md-4">
                            <img src="{{ asset('compro/assets/img/landing/saas-2/features/analytics.svg') }}" width="40"
                                alt="Analytics">
                        </div>
                        <div class="card-body text-center">
                ...
                <div class="col position-relative">
                    <div class="card border-0 bg-transparent rounded-0 p-md-1 p-xl-3">
                        <div class="d-table bg-secondary rounded-3 p-3 mx-auto mt-3 mt-md-4">
                            <img src="{{ asset('compro/assets/img/landing/saas-2/features/group.svg') }}" width="40"
                                alt="Group">
                        </div>
                        <div class="card-body text-center">
                ...
                <div class="col position-relative">
                    <div class="card border-0 bg-transparent rounded-0 p-md-1 p-xl-3">
                        <div class="d-table bg-secondary rounded-3 p-3 mx-auto mt-3 mt-md-4">
                            <img src="{{ asset('compro/assets/img/landing/saas-2/features/notifications.svg') }}"
                                width="40" alt="Notifications">
                        </div>
                        <div class="card-body text-center">
                ...
                <div class="col position-relative">
                    <div class="card border-0 bg-transparent rounded-0 p-md-1 p-xl-3">
                        <div class="d-table bg-secondary rounded-3 p-3 mx-auto mt-3 mt-md-4">
                            <img src="{{ asset('compro/assets/img/landing/saas-2/features/tasks.svg') }}" width="40"
                                alt="Tasks">
                        </div>
                        <div class="card-body text-center">
                ...
                <div class="col position-relative">
                    <div class="card border-0 bg-transparent rounded-0 p-md-1 p-xl-3">
                        <div class="d-table bg-secondary rounded-3 p-3 mx-auto mt-3 mt-md-4">
                            <img src="{{ asset('compro/assets/img/landing/saas-2/features/security.svg') }}"
                                width="40" alt="Security">
                        </div>
                        <div class="card-body text-center">
                ...
                <div class="mx-n4 mx-sm-n5 mx-xl-0">
                    <div class="mx-n5 mx-xl-0">
                        <img-comparison-slider class="mx-n5 mx-xl-0">
                            <img slot="first" src="{{ asset('compro/assets/img/landing/saas-2/dark-mode.jpg') }}"
                                alt="Dak Mode">
                            <img slot="second" src="{{ asset('compro/assets/img/landing/saas-2/light-mode.jpg') }}"
                                alt="Light Mode">
                            <div slot="handle">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide h-auto pt-4">
                            <figure class="d-flex flex-column h-100 px-2 px-sm-0 mb-0 mx-2">
                                ...
                                <figcaption class="d-flex align-items-center ps-4 pt-4">
                                    <img src="{{ asset('compro/assets/img/avatar/16.jpg') }}" width="48"
                                        class="rounded-circle" alt="Robert Fox">
                                    <div class="ps-3">
                        ...
                        <div class="swiper-slide h-auto pt-4">
                            <figure class="d-flex flex-column h-100 px-2 px-sm-0 mb-0 mx-2">
                                ...
                                <figcaption class="d-flex align-items-center ps-4 pt-4">
                                    <img src="{{ asset('compro/assets/img/avatar/08.jpg') }}" width="48"
                                        class="rounded-circle" alt="Annette Black">
                                    <div class="ps-3">
                        ...
                        <div class="swiper-slide h-auto pt-4">
                            <figure class="d-flex flex-column h-100 px-2 px-sm-0 mb-0 mx-2">
                                ...
                                <figcaption class="d-flex align-items-center ps-4 pt-4">
                                    <img src="{{ asset('compro/assets/img/avatar/13.jpg') }}" width="48"
                                        class="rounded-circle" alt="Jerome Bell">
                                    <div class="ps-3">
                        ...
                        <div class="swiper-slide h-auto pt-4">
                            <figure class="d-flex flex-column h-100 px-2 px-sm-0 mb-0 mx-2">
                                ...
                                <figcaption class="d-flex align-items-center ps-4 pt-4">
                                    <img src="{{ asset('compro/assets/img/avatar/09.jpg') }}" width="48"
                                        class="rounded-circle" alt="Albert Flores">
                                    <div class="ps-3">
            ...
            <div class="row align-items-center py-sm-2">
                ...
                <div class="col-md-7 col-lg-6 offset-xl-1">
                    <div class="position-relative mx-auto mb-5 m-md-0" style="max-width: 526px;">
                        <img src="{{ asset('compro/assets/img/landing/saas-2/device.png') }}" class="d-block"
                            alt="Device">
                        <div class="rellax d-block position-absolute top-0 end-0 w-100 mt-md-4 me-md-n5" alt="App Screen"
                    ...
                    <div class="row">
                            ...
                            <div
                                ...
                                <div class="col d-lg-flex justify-content-end">
                                    <a href="#" class="btn btn-dark btn-lg px-3 py-2">
                                        <img src="{{ asset('compro/assets/img/market/appstore-light.svg') }}"
                                            class="light-mode-img" width="124" alt="App Store">
                                        <img src="{{ asset('compro/assets/img/market/appstore-dark.svg') }}"
                                            class="dark-mode-img" width="124" alt="App Store">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-12">
                            <div class="row row-cols-1 row-cols-lg-2 align-items-end text-center text-md-start">
                                ...
                                <div class="col d-lg-flex justify-content-end">
                                    <a href="#" class="btn btn-dark btn-lg px-3 py-2">
                                        <img src="{{ asset('compro/assets/img/market/googleplay-light.svg') }}"
                                            class="light-mode-img" width="139" alt="Google Play">
                                        <img src="{{ asset('compro/assets/img/market/googleplay-dark.svg') }}"
                                            class="dark-mode-img" width="139" alt="Google Play">
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-2 g-sm-3 g-lg-4 pb-md-3 pb-lg-5">
            ...
            <div class="col">
                <div class="card card-body card-hover bg-light border-0">
                    <img src="{{ asset('compro/assets/img/brands/google.svg') }}" class="d-block mb-4" width="56"
                        alt="Google">
            ...
            <div class="col">
                <div class="card card-body card-hover bg-light border-0">
                    <img src="{{ asset('compro/assets/img/brands/zoom.svg') }}" class="d-block mb-4" width="56"
                        alt="Zoom">
            ...
            <div class="col">
                <div class="card card-body card-hover bg-light border-0">
                    <img src="{{ asset('compro/assets/img/brands/slack.svg') }}" class="d-block mb-4" width="56"
                        alt="Slack">
            ...
            <div class="col">
                <div class="card card-body card-hover bg-light border-0">
                    <img src="{{ asset('compro/assets/img/brands/gmail.svg') }}" class="d-block mb-4" width="56"
                        alt="Gmail">
            ...
            <div class="col">
                <div class="card card-body card-hover bg-light border-0">
                    <img src="{{ asset('compro/assets/img/brands/trello.svg') }}" class="d-block mb-4" width="56"
                        alt="Trello">
            ...
            <div class="col">
                <div class="card card-body card-hover bg-light border-0">
                    <img src="{{ asset('compro/assets/img/brands/mailchimp.svg') }}" class="d-block mb-4" width="56"
                        alt="Mailchimp">
            ...
            <div class="col">
                <div class="card card-body card-hover bg-light border-0">
                    <img src="{{ asset('compro/assets/img/brands/dropbox.svg') }}" class="d-block mb-4" width="56"
                        alt="Dropbox">
            ...
            <div class="col">
                <div class="card card-body card-hover bg-light border-0">
                    <img src="{{ asset('compro/assets/img/brands/evernote.svg') }}" class="d-block mb-4" width="56"
                        alt="Evernote">
